...
for quote in response.xpath('//ul[@class="sellListContent"]'):
    ...
    print quote.xpath('.//div[@class="page-box fr"]')
    print "***************************************************"
