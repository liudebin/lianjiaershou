...
class ToScrapeSpiderXPath(scrapy.Spider):
    ...
    sql = "update ershoufang_detail_lianjia set rent_status = -1 where rent_status <> -1 ;"
    ...
    for num in range(102):
        pages = 'https://sh.lianjia.com/ershoufang/pg{0}'.format(num)
        box.append(pages)
    start_urls = box

    # start_urls = [
    #     'https://sh.lianjia.com/ershoufang/c5011000010470/',
    # ]
